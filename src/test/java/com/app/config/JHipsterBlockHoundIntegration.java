...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.app.security.DomainUserDetailsService", "createSpringSecurityUser");
